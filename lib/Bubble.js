...
export default class Bubble extends React.Component {
    ...
    render() {
        const { position, containerStyle, wrapperStyle, bottomContainerStyle, backgroundGradientStyle, } = this.props;
        return (<View style={[
                styles[position].container,
                containerStyle && containerStyle[position],
            ]}>
        <LinearGradient start={backgroundGradientStyle[position].backgroundGradientStart} end={backgroundGradientStyle[position].backgroundGradientEnd} colors={[
