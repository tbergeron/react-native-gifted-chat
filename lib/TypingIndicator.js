...
const TypingIndicator = ({ isTyping, backgroundColor, dotColor }) => {
    ...
    return (<Animated.View style={[
      ...
      {isTyping ? (<TypingAnimation style={{ marginLeft: 6, marginTop: 7.2 }} dotRadius={4} dotMargin={5.5} dotColor={dotColor ? dotColor : 'rgba(0, 0, 0, 0.38)'}/>) : null}
    </Animated.View>);
};
